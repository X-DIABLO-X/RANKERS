...
const users = [
    ...
    { name: "Bob",group: "Advance", codechef: 2000, codeforces: 1800, atcoder: 1600, leetcode: 2500 },
    { name: "Charlie",group: "Group 2", codechef: 2500, codeforces: 2200, atcoder: 2000, leetcode: 3000 },
    { name: "David",group: "Group 1", codechef: 1800, codeforces: 8000, atcoder: 1400, leetcode: 2200 },
    { name: "Eve",group: "Intermediate", codechef: 3000, codeforces: 2800, atcoder: 2400, leetcode: 3500 },
];
...
function populateLeaderboard(sortBy = 'average') {
    ...
    users.forEach((user, index) => {
        ...
        row.innerHTML = `
            <td>${index + 1}</td>
            <td>${user.name}</td>
            <td>${getGroupColor(user.group)}</td>
